<?php
/**
 * ProcessPlugin  - ProcessPlugin.class.php
 * 
 * This is one of two diferent ways of abstract implementation of the Plugin 
 * interface. This class implements all required methods required by his 
 * interface and need to be extended by a concrete class to enable his 
 * instantiating and functionality. Extend this class insted implement the 
 * Plugin inteface to handle process plugins.
 * 
 * PHP version 5
 * 
 ...
 * @version    SVN: $Id: AbstractPlugin.class.php 662 2009-03-11 04:30:31Z flavio.garcia $
 */
 ...
 * @since      Revision 805
 */
abstract class ProcessPlugin implements Plugin {
